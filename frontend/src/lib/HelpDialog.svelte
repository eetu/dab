  ...
  <div class="cols">
    <section>
      ...
      <p>
        ...
        frame by its number — the dotted grip under the picture — to reorder the strip, and the
        animations follow. Click an animation's name to see its steps in playing order and drag
        those to reorder the run itself; double-click renames. Press play and the sprite runs
